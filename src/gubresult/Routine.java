...
public class Routine extends javax.swing.JFrame {
    ...
    public Routine() {
        ...
        try {
            ...
            String q = "SELECT * from routine";
            ResultSet rs = st.executeQuery(q);
            
            DefaultTableModel tm = (DefaultTableModel)RoutineList.getModel();
            tm.setRowCount(0);
            int i = 0;
            while(rs.next()) {
                Object o[] = {++i, rs.getString("batch"), rs.getString("section"), rs.getString("time")};
                tm.addRow(o);
            }
        } catch(Exception e) {
    ...
    private void initComponents() {
        ...
        RoutineList = new javax.swing.JTable();
        ...
        RoutineList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private javax.swing.JTable RoutineList;
