...
public class Teacher extends javax.swing.JFrame {
    ...
    public Teacher() {
        ...
        try {
            ...
            DefaultTableModel tm = (DefaultTableModel)TeacherList.getModel();
            tm.setRowCount(0);
            int i = 0;
            while(rs.next()) {
                Object o[] = {++i, rs.getString("name"), rs.getString("phone"), rs.getString("username")};
                tm.addRow(o);
            }
        } catch(Exception e) {
